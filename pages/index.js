    ...
    <div className="font-poppins">
      ...
      <div
        className={classNames(
          "w-full max-w-2xl flex flex-col items-center px-20 gap-20 m-auto",
      ...
      >
        ...
        <div className="mt-30 lg:mt-55 sm:mt-30 relative">
          <div className="flex justify-between items-center ">
            <div className="text-black mb-10 lg:text-32 text-20 leading-10 sm:text-20 sm:leading-10 md:text-28 md:leading-48 font-medium">
              Events This Weekend
            </div>
          </div>
          <div
      ...
      <div className="px-20 max-w-2xl m-auto">
        <EventsCategory />
      </div>
      <div className="">
        <Footer />
