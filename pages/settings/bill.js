...
import FormSelectOption from "../../components/dropdown/FormSelectOption";
                  ...
                  <div className="flex gap-10 sm:flex-col lg:flex-row ms:flex-col">
                    <div className="font-normal text-sm">
                      ...
                      <FormSelectOption
                        ...
                        name="country"
                        componentstyle="w-screen border-1 border-solid border-bordergrey min-h-[37x] rounded-5 pr-12 max-w-[314px] flex  justify-between  items-center px-5"
                        borderstyle="border-0.5 border-solid border-eventcreate"
                      />
                    </div>
                    <div className="font-normal text-sm">
                      <label>State</label>
