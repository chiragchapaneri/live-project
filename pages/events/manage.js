...
const Manage = (props) => {
  ...
  const {
    ...
    currentPage: state.manageEventSlice.currentPage,
  }));
          ...
          return (
            <div className="flex items-center justify-center">
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute w-200 z-[3] right-15 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                          ...
                          <button
                            ...
                            className={`${
                              active
                                ...
                                : "text-gray-900  disabled:text-gray-400 disabled:cursor-not-allowed"
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="px-100 ms:px-20 sm:px-20 md:px-30 lg:px-40 xl:px-100 xxl:px-100">
          <div
            ...
            min-h-[680px] max-h-[calc(100vh-258px)]`}
          >
            {/* {eventList?.length > 0 ? ( */}
                        ...
                        return (
                          <tr
                            className={classNames(
                              "py-39 rounded-5 shadow-lg hover:shadow-cyan-500/20",
