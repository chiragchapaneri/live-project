...
const Orderpage = ({ id }) => {
  ...
  return tableOrderData.length > 0 ? (
    <div className="mx-auto w-full">
      ...
      <div className="flex flex-col max-w-2xl mx-auto gap-30 mt-10 p-20 ">
    ...
    <div className="absolute max-w-2xl mx-auto top-0 left-0 z-50 w-screen h-screen flex justify-center items-center ">
      <Bars
        height="80"
        width="80"
        color="#0090E1"
