  ...
  return (
    <div
      className={classNames(
        "z-10 h-60 flex items-center w-full xl:px-pl-20 sm:px-20 ms:px-10 ",
        router.route !== "/" ? "justify-between" : "justify-between",
        props.headerStyle,
        props.textStyle
      )}
    >
      <div className="w-full max-w-2xl flex justify-between mx-auto items-center">
        <LogoutModal
        ...
        {show && (
          <div className="h-screen w-screen top-0 left-0 bg-white z-50 fixed ">
            <div className="flex justify-between px-10 py-10 relative items-center">
              <a>
          ...
          <div className="flex gap-25">
            ...
            >
              <div className="hidden text-white text-base leading-6 font-medium lg:flex md:gap-18">
                <Link href="/event/search">
                  <a
                    className={classNames("whitespace-nowrap", props.textStyle)}
                  >
                    Find events
                  </a>
                </Link>
