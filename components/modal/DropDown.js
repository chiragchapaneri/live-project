          ...
          >
            <Listbox.Options
              className={classNames(
                "absolute mt-1 w-full max-w-[60px] overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-99 px-15",
                ...
                (person, personIdx) =>
                  personIdx <= props?.quantity && (
                    <Listbox.Option
                      ...
                      className={({ active }) => {
                        classNames(
                          "relative cursor-default select-none py-2 text-center pr-4",
                          active
